...
const Work = ({ hero }) => {
    ...
    const block = [
    { filename: thumbnail01, alt: "コーヒー豆の販売", title: "コーヒー豆の販売", text: "コーヒーはフルーツの種です。フルーツでも様々な味があるように、コーヒーも個性豊かで、産地・農園や精製のプロセスによっても様々な味わいがあります。\nプレイズコーヒーでは素材の味がわかる焙煎度合いでコーヒーを焙煎しています。", url: "/beans", page: "コーヒー豆をみる" },
    { filename: thumbnail02, alt: "カフェの運営", title: "カフェの運営", text: "プレイズコーヒーでは、高品質なスペシャルティコーヒーの豆を使用した様々なメニューをご用意しています。\nフレッシュで果実のような味やチョコレートのように甘いコーヒー、お花のような華やかなコーヒー、ミルクに合うコーヒーなど、個性豊かなコーヒーの味をお楽しみください。", url: "/menu", page: "カフェのメニューをみる" }
]
